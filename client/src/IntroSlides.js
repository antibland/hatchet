    ...
    return (
      <Swiper {...params}>
        <div className="swiper-slide" id="step1">
          <img
            className="image"
            src="./svg/icon-intro-argument.svg"
            alt="Opposing chat bubbles"
          />
        ...
        <div className="swiper-slide" id="step2">
          ...
          <div className="text">
            Your opponent has 24 hours to respond with a counter argument.
          </div>
        </div>
        <div className="swiper-slide" id="step3">
          <img
            className="image"
            src="./svg/icon-intro-voting.svg"
            alt="Ballot box"
          />
          <div className="title">Voting Begins</div>
          <div className="text">
            Allow the fate of your dispute to be decided by a jury of your
            peers.
          </div>
        </div>
        <div className="swiper-slide" id="step4">
          <img
            className="image"
            src="./svg/icon-intro-trophy.svg"
            alt="Trophy"
          />
          <div className="title">Bury The Hatchet</div>
          <div className="text">
            Once the winner is chosen, agree to accept the verdict and let go of
            the argument.
          </div>
        </div>
      </Swiper>
